...
const Profile = () => {
            ...
            axios
              ...
              .then((response) => {
                ...
                if (response.data.success) {
                  // Use reset() to reset the form after successful submission
                  reset(); // Add this line
                  Swal.fire({
                    position: 'top-end',
                    icon: 'success',
                    title: `${dbUser.name} has been updated!`,
    ...
    return (
        <div className="w-2/3 mx-auto">
            <div className={`${editMode ? "hidden" : "block"} flex flex-col items-center space-x-4 mb-4`}>
                ...
                <div>
                    <h1 className="text-4xl font-bold">{dbUser[0]?.name}</h1>
